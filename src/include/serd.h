...
*/
SERD_API size_t serd_strlen(const uint8_t *SERD_NONNULL str, size_t *SERD_NULLABLE n_bytes,
...
*/
SERD_API double serd_strtod(const char *SERD_NONNULL str, char *SERD_UNSPECIFIED *SERD_NULLABLE endptr);
...
*/
SERD_API void *SERD_ALLOCATED serd_base64_decode(const uint8_t *SERD_NONNULL str, size_t len,
...
*/
typedef size_t (*SerdSource)(void *SERD_NONNULL buf, size_t size, size_t nmemb, void *SERD_UNSPECIFIED stream);

/// Sink function for raw string output
typedef size_t (*SerdSink)(const void *SERD_NONNULL buf, size_t len, void *SERD_UNSPECIFIED stream);
...
*/
SERD_API void serd_uri_resolve(const SerdURI *SERD_NONNULL r, const SerdURI *SERD_NONNULL base,
                               SerdURI *SERD_NONNULL t);

/// Serialise `uri` with a series of calls to `sink`
SERD_API size_t serd_uri_serialise(const SerdURI *SERD_NONNULL uri, SerdSink SERD_NONNULL sink,
...
*/
SERD_API size_t serd_uri_serialise_relative(const SerdURI *SERD_NONNULL uri, const SerdURI *SERD_NULLABLE base,
                                            const SerdURI *SERD_NULLABLE root, SerdSink SERD_NONNULL sink,
                                            void *SERD_UNSPECIFIED stream);
...
SERD_API SerdNode serd_node_new_uri_from_node(const SerdNode *SERD_NONNULL uri_node, const SerdURI *SERD_NULLABLE base,
                                              SerdURI *SERD_NULLABLE out);

/// Simple wrapper for serd_node_new_uri() to resolve a URI string
SERD_API SerdNode serd_node_new_uri_from_string(const uint8_t *SERD_NULLABLE str, const SerdURI *SERD_NULLABLE base,
                                                SerdURI *SERD_NULLABLE out);
...
*/
SERD_API SerdNode serd_node_new_file_uri(const uint8_t *SERD_NONNULL path, const uint8_t *SERD_NULLABLE hostname,
                                         SerdURI *SERD_NULLABLE out, bool escape);
...
*/
SERD_API SerdNode serd_node_new_uri(const SerdURI *SERD_NONNULL uri, const SerdURI *SERD_NULLABLE base,
                                    SerdURI *SERD_NULLABLE out);
...
/**
   ...
   memory owned by the new returned node).
*/
SERD_API SerdNode serd_node_new_relative_uri(const SerdURI *SERD_NONNULL uri, const SerdURI *SERD_NULLABLE base,
                                             const SerdURI *SERD_NULLABLE root, SerdURI *SERD_NULLABLE out);
...
*/
typedef SerdStatus (*SerdErrorSink)(void *SERD_UNSPECIFIED handle, const SerdError *SERD_NONNULL error);
...
*/
typedef SerdStatus (*SerdBaseSink)(void *SERD_UNSPECIFIED handle, const SerdNode *SERD_NONNULL uri);
...
*/
typedef SerdStatus (*SerdPrefixSink)(void *SERD_UNSPECIFIED handle, const SerdNode *SERD_NONNULL name,
...
*/
typedef SerdStatus (*SerdStatementSink)(void *SERD_UNSPECIFIED handle, SerdStatementFlags flags,
                                        const SerdNode *SERD_NULLABLE graph, const SerdNode *SERD_NONNULL subject,
                                        const SerdNode *SERD_NONNULL predicate, const SerdNode *SERD_NONNULL object,
...
*/
typedef SerdStatus (*SerdEndSink)(void *SERD_UNSPECIFIED handle, const SerdNode *SERD_NONNULL node);
...
*/
SERD_API SerdStatus serd_env_set_prefix(SerdEnv *SERD_NONNULL env, const SerdNode *SERD_NONNULL name,
                                        const SerdNode *SERD_NONNULL uri);

/// Set a namespace prefix
SERD_API SerdStatus serd_env_set_prefix_from_strings(SerdEnv *SERD_NONNULL env, const uint8_t *SERD_NONNULL name,
                                                     const uint8_t *SERD_NONNULL uri);

/// Qualify `uri` into a CURIE if possible
SERD_API bool serd_env_qualify(const SerdEnv *SERD_NULLABLE env, const SerdNode *SERD_NONNULL uri,
                               SerdNode *SERD_NONNULL prefix, SerdChunk *SERD_NONNULL suffix);
...
*/
SERD_API SerdStatus serd_env_expand(const SerdEnv *SERD_NULLABLE env, const SerdNode *SERD_NONNULL curie,
                                    SerdChunk *SERD_NONNULL uri_prefix, SerdChunk *SERD_NONNULL uri_suffix);
...
*/
SERD_API SerdNode serd_env_expand_node(const SerdEnv *SERD_NULLABLE env, const SerdNode *SERD_NONNULL node);

/// Call `func` for each prefix defined in `env`
SERD_API void serd_env_foreach(const SerdEnv *SERD_NONNULL env, SerdPrefixSink SERD_NONNULL func,
...
SERD_API SerdReader *SERD_ALLOCATED serd_reader_new(SerdSyntax syntax, void *SERD_UNSPECIFIED handle,
...
*/
SERD_API void serd_reader_set_error_sink(SerdReader *SERD_NONNULL reader, SerdErrorSink SERD_NULLABLE error_sink,
                                         void *SERD_UNSPECIFIED error_handle);

/// Return the `handle` passed to serd_reader_new()
SERD_PURE_API void *SERD_UNSPECIFIED serd_reader_get_handle(const SerdReader *SERD_NONNULL reader);
...
*/
SERD_API SerdStatus serd_reader_start_stream(SerdReader *SERD_NONNULL reader, FILE *SERD_NONNULL file,
                                             const uint8_t *SERD_NULLABLE name, bool bulk);
...
*/
SERD_API SerdStatus serd_reader_start_source_stream(SerdReader *SERD_NONNULL reader, SerdSource SERD_NONNULL read_func,
                                                    SerdStreamErrorFunc SERD_NONNULL error_func,
                                                    void *SERD_UNSPECIFIED stream, const uint8_t *SERD_NULLABLE name,
                                                    size_t page_size);
...
/// Read `file`
SERD_API SerdStatus serd_reader_read_file_handle(SerdReader *SERD_NONNULL reader, FILE *SERD_NONNULL file,
                                                 const uint8_t *SERD_NULLABLE name);

/// Read a user-specified byte source
SERD_API SerdStatus serd_reader_read_source(SerdReader *SERD_NONNULL reader, SerdSource SERD_NONNULL source,
                                            SerdStreamErrorFunc SERD_NONNULL error, void *SERD_UNSPECIFIED stream,
                                            const uint8_t *SERD_NULLABLE name, size_t page_size);
...
*/
SERD_API SerdStatus serd_reader_skip_until_byte(SerdReader *SERD_NONNULL reader, uint8_t byte);
...
SERD_API SerdWriter *SERD_ALLOCATED serd_writer_new(SerdSyntax syntax, SerdStyle style, SerdEnv *SERD_NONNULL env,
                                                    const SerdURI *SERD_NULLABLE base_uri, SerdSink SERD_NONNULL ssink,
                                                    void *SERD_UNSPECIFIED stream);
...
*/
SERD_API size_t serd_file_sink(const void *SERD_NONNULL buf, size_t len, void *SERD_UNSPECIFIED stream);
...
*/
SERD_API size_t serd_chunk_sink(const void *SERD_NONNULL buf, size_t len, void *SERD_UNSPECIFIED stream);
...
*/
SERD_API void serd_writer_set_error_sink(SerdWriter *SERD_NONNULL writer, SerdErrorSink SERD_NONNULL error_sink,
                                         void *SERD_UNSPECIFIED error_handle);
...
*/
SERD_API SerdStatus serd_writer_set_prefix(SerdWriter *SERD_NONNULL writer, const SerdNode *SERD_NONNULL name,
                                           const SerdNode *SERD_NONNULL uri);
...
SERD_API SerdStatus serd_writer_write_statement(
    SerdWriter *SERD_NONNULL writer, SerdStatementFlags flags, const SerdNode *SERD_NULLABLE graph,
    const SerdNode *SERD_NONNULL subject, const SerdNode *SERD_NONNULL predicate, const SerdNode *SERD_NONNULL object,
    const SerdNode *SERD_NULLABLE datatype, const SerdNode *SERD_NULLABLE lang);
